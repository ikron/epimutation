...
output.H3K27_exH3K9.CHG <- buildPedigree(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHG", posteriorMaxFilter = 0.99)

save(output.H3K27_exH3K9.CHG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/MA_CHG_H3K27_exH3K9.RData")
