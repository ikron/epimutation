...
output.H3K9_excent.CHH <- buildPedigree(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.H3K9_excent.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/MA_CHH_H3K9_ex_cent.RData")
