...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_H3K27_exH3K9.fn"
...
output.H3K27_exH3K9.CHH <- buildPedigree(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.H3K27_exH3K9.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/MA_CHH_H3K27_exH3K9.RData")
