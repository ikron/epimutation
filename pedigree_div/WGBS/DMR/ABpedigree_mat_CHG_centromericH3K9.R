...
output.matA.centromericH3K9.CHG <- buildPedigree(nodelist = nodeFile.matA, edgelist = edgeFile.matA, cytosine = "CHG", posteriorMaxFilter = 0.99)

output.mata.centromericH3K9.CHG <- buildPedigree(nodelist = nodeFile.mata, edgelist = edgeFile.mata, cytosine = "CHG", posteriorMaxFilter = 0.99)

save(output.matA.centromericH3K9.CHG, output.mata.centromericH3K9.CHG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/MA_mat_CHG_centromericH3K9.RData")
