...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_euchromatin_CG.fn"
...
output.DMR.euchromatin.CG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.DMR.euchromatin.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_euchromatin/MA_DMR_euchromatin_CG.RData")
