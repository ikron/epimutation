...
nodeFile.matA <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_matA_DMR_CG.fn"
...
output.matA.DMR.all.CG <- buildPedigreeRegions(nodelist = nodeFile.matA, edgelist = edgeFile.matA, cytosine = "CG", posteriorMaxFilter = 0.99)

output.mata.DMR.all.CG <- buildPedigreeRegions(nodelist = nodeFile.mata, edgelist = edgeFile.mata, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.matA.DMR.all.CG, output.mata.DMR.all.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_all/MA_DMR_all_mat_CG.RData")
