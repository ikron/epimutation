...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_CG.fn"
...
output.DMR.all.CG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.DMR.all.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_all/MA_DMR_all_CG.RData")
