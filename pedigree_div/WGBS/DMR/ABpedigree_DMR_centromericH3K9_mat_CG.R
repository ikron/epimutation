...
nodeFile.matA <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_matA_DMR_centromericH3K9_CG.fn"
...
output.matA.DMR.centromeric.CG <- buildPedigreeRegions(nodelist = nodeFile.matA, edgelist = edgeFile.matA, cytosine = "CG", posteriorMaxFilter = 0.99)

output.mata.DMR.centromeric.CG <- buildPedigreeRegions(nodelist = nodeFile.mata, edgelist = edgeFile.mata, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.matA.DMR.centromeric.CG, output.mata.DMR.centromeric.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_centromericH3K9/MA_DMR_centromericH3K9_mat_CG.RData")
