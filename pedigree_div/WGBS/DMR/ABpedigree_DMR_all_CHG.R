...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_CHG.fn"
...
output.DMR.all.CHG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHG", posteriorMaxFilter = 0.99)

save(output.DMR.all.CHG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_all/MA_DMR_all_CHG.RData")
