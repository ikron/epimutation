...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_euchromatin_CHG.fn"
...
output.DMR.euchromatin.CHG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHG", posteriorMaxFilter = 0.99)

save(output.DMR.euchromatin.CHG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_euchromatin/MA_DMR_euchromatin_CHG.RData")
