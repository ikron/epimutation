...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_excent_CG.fn"
...
output.DMR.excent.CG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.DMR.excent.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_excent/MA_DMR_excent_CG.RData")
