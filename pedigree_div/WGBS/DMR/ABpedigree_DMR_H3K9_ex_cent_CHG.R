...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_H3K9_ex_cent_CHG.fn"
...
output.DMR.H3K9_ex_cent.CHG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHG", posteriorMaxFilter = 0.99)

save(output.DMR.H3K9_ex_cent.CHG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_H3K9_ex_cent/MA_DMR_H3K9_ex_cent_CHG.RData")
