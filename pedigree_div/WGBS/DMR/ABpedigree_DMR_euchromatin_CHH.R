...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_euchromatin_CHH.fn"
...
output.DMR.euchromatin.CHH <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.DMR.euchromatin.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_euchromatin/MA_DMR_euchromatin_CHH.RData")
