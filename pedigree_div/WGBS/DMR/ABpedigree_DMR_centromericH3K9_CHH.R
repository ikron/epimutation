...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_centromericH3K9_CHH.fn"
...
output.DMR.centromericH3K9.CHH <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.DMR.centromericH3K9.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_centromericH3K9/MA_DMR_centromericH3K9_CHH.RData")
