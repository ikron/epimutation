...
nodeFile.matA <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_matA_DMR_CHH.fn"
...
output.matA.DMR.all.CHH <- buildPedigreeRegions(nodelist = nodeFile.matA, edgelist = edgeFile.matA, cytosine = "CHH", posteriorMaxFilter = 0.99)

output.mata.DMR.all.CHH <- buildPedigreeRegions(nodelist = nodeFile.mata, edgelist = edgeFile.mata, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.matA.DMR.all.CHH, output.mata.DMR.all.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_all/MA_DMR_all_mat_CHH.RData")
