...
nodeFile.matA <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_matA_DMR_centromericH3K9_CHH.fn"
...
output.matA.DMR.centromeric.CHH <- buildPedigreeRegions(nodelist = nodeFile.matA, edgelist = edgeFile.matA, cytosine = "CHH", posteriorMaxFilter = 0.99)

output.mata.DMR.centromeric.CHH <- buildPedigreeRegions(nodelist = nodeFile.mata, edgelist = edgeFile.mata, cytosine = "CHH", posteriorMaxFilter = 0.99)

save(output.matA.DMR.centromeric.CHH, output.mata.DMR.centromeric.CHH, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_centromericH3K9/MA_DMR_centromericH3K9_mat_CHH.RData")
