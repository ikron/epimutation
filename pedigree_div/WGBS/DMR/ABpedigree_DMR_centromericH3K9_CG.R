...
nodeFile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/nodelist_DMR_centromericH3K9_CG.fn"
...
output.DMR.centromericH3K9.CG <- buildPedigreeRegions(nodelist = nodeFile, edgelist = edgeFile, cytosine = "CG", posteriorMaxFilter = 0.99)

save(output.DMR.centromericH3K9.CG, file = "/scratch/project_2000350/genomics/methylation/methimpute/pedigreedata/DMR_centromericH3K9/MA_DMR_centromericH3K9_CG.RData")
