...
samplefile_H3K9excent <- "/scratch/project_2000350/genomics/nanopore/MAlines_5mC/list_files/list_file_H3K9excent.fn"
samplefile_H3K9cent <- "/scratch/project_2000350/genomics/nanopore/MAlines_5mC/list_files/list_file_H3K9cent.fn"
...
runMethimputeGrid(out.dir = out.dir, fasta = reference, samplefiles = samplefile_H3K9excent, win = 100, step = 100, nCytosines = 5, mincov = 5, context = c("CG", "CHG", "CHH"), genome = "Neurospora")
runMethimputeGrid(out.dir = out.dir, fasta = reference, samplefiles = samplefile_H3K9cent, win = 100, step = 100, nCytosines = 5, mincov = 5, context = c("CG", "CHG", "CHH"), genome = "Neurospora")
