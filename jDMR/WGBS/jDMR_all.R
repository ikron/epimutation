...
out.dir <- "/scratch/project_2000350/genomics/methylation/jDMR/all"
reference <- "/scratch/project_2000350/genomics/methylation/mreference/fastafiles"
samplefile <- "/scratch/project_2000350/genomics/methylation/methimpute/control/listFiles_all.fn"
matresults <- "/scratch/project_2000350/genomics/methylation/jDMRmatrix/all"
